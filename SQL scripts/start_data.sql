...
INSERT INTO driver (full_name, employment_start)
  ...
  INSERT INTO driver (full_name, employment_start)
  VALUES ('Тест1', TO_DATE('2010-03-01', 'YYYY-MM-DD'));
INSERT INTO driver (full_name, employment_start)
  VALUES ('Тест1 Джонсон', TO_DATE('2012-05-10', 'YYYY-MM-DD'));
INSERT INTO driver (full_name, employment_start)
  VALUES ('Тест1 Браун', TO_DATE('2015-07-15', 'YYYY-MM-DD'));
INSERT INTO driver (full_name, employment_start)
  VALUES ('Тест1 Уильямс', TO_DATE('2018-09-05', 'YYYY-MM-DD'));
INSERT INTO driver (full_name, employment_start)
  VALUES ('Тест1 Тейлор', TO_DATE('2017-02-25', 'YYYY-MM-DD'));
INSERT INTO driver (full_name, employment_start)
  VALUES ('Тест1 Грин', TO_DATE('2016-10-30', 'YYYY-MM-DD'));
INSERT INTO driver (full_name, employment_start)
  VALUES ('Тест1 Уайт', TO_DATE('2019-04-01', 'YYYY-MM-DD'));
...
INSERT INTO driver_vehicle_type (driver_id, vehicle_type_id) VALUES (8, 1);
INSERT INTO driver_vehicle_type (driver_id, vehicle_type_id) VALUES (9, 2);
INSERT INTO driver_vehicle_type (driver_id, vehicle_type_id) VALUES (10, 1);
INSERT INTO driver_vehicle_type (driver_id, vehicle_type_id) VALUES (11, 3);
INSERT INTO driver_vehicle_type (driver_id, vehicle_type_id) VALUES (12, 2);
INSERT INTO driver_vehicle_type (driver_id, vehicle_type_id) VALUES (8, 4);
INSERT INTO driver_vehicle_type (driver_id, vehicle_type_id) VALUES (9, 3);
INSERT INTO driver_vehicle_type (driver_id, vehicle_type_id) VALUES (10, 5);
INSERT INTO driver_vehicle_type (driver_id, vehicle_type_id) VALUES (11, 4);
INSERT INTO driver_vehicle_type (driver_id, vehicle_type_id) VALUES (12, 6);
INSERT INTO driver_vehicle_type (driver_id, vehicle_type_id) VALUES (8, 3);
INSERT INTO driver_vehicle_type (driver_id, vehicle_type_id) VALUES (9, 4);
INSERT INTO driver_vehicle_type (driver_id, vehicle_type_id) VALUES (10, 6);
INSERT INTO driver_vehicle_type (driver_id, vehicle_type_id) VALUES (11, 6);
...
INSERT INTO trip_request (route_name, distance, creation_date, status, required_vehicle_type_id) 
  VALUES ('Тест1 - Тест1', 250, TO_DATE('2025-01-25', 'YYYY-MM-DD'), 'Ожидает', 1);
  INSERT INTO trip_request (route_name, distance, creation_date, status, required_vehicle_type_id) 
  VALUES ('Тест2 - Тест2', 500, TO_DATE('2025-01-25', 'YYYY-MM-DD'), 'Ожидает', 2);
  INSERT INTO trip_request (route_name, distance, creation_date, status, required_vehicle_type_id) 
  VALUES ('Тест3 - Тест3', 100, TO_DATE('2025-01-25', 'YYYY-MM-DD'), 'Ожидает', 3);
  INSERT INTO trip_request (route_name, distance, creation_date, status, required_vehicle_type_id) 
  VALUES ('Тест4 - Тест4', 250, TO_DATE('2025-01-25', 'YYYY-MM-DD'), 'Ожидает', 4);
