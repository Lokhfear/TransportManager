object DBConnect: TDBConnect
  ...
  object DriverLicensesQuery: TFDQuery
    ...
    SQL.Strings = (
        ...
        'select driver_id, license_category_id, category_name as license_' +
  ...
  object licenseCategoryDataSource: TDataSource
    ...
    OnDataChange = licenseCategoryDataSourceDataChange
    Left = 136
    Top = 384
  end
  object DriverLecensesDataSource: TDataSource
    DataSet = DriverLicensesQuery
    Left = 568
    Top = 136
  end
end
