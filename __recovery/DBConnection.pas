...
type
  TDBConnect = class(TForm)
    ...
    DriverLecensesDataSource: TDataSource;
    procedure licenseCategoryDataSourceDataChange(Sender: TObject;
      Field: TField);
  private
...
procedure TDBConnect.licenseCategoryDataSourceDataChange(Sender: TObject;
  Field: TField);
begin
